...
"forked" from penn_chime to add the ability to read a series of
    social distancing changes over time
"""
...
from penn_chime.constants import (
    CHANGE_DATE,
    VERSION,
)
from penn_chime.model.validators import (
    Date,
    GteOne,
    OptionalDate,
    OptionalValue,
...
VALIDATORS = {
    ...
    "mitigation_model": OptionalValue,
    "market_share": Rate,
...
HELP = {
    ...
    "mitigation_model" : "Model file with social distancing measures by date and impact",
